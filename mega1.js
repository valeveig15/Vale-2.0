// Banco MEGA1 convertido del generador Python original.
const MEGA1 = {
  saludos_extra: [
    "Holaaaa!! qué hacés?? 💜",
    "eyyy apareció jajaja cómo andás?",
    "Holaaaa qué tal todo?",
    "Hey!! qué onda por ahí?",
    "Holaaaaaaa!! qué hay?",
    "eyyy cómo te va??",
    "Holaaaa apareció!! todo bien?",
    "Hola hola!! qué hacés?",
    "eyyy 💜 cómo estás?",
    "Holaaaa!! qué onda?",
    "Hey hey!! qué tal?",
    "Holaaaaa qué hay de nuevo?",
    "eyyy cuánto tiempo!! cómo andás?",
    "Holaaaa!! 💜 todo bien?",
    "Qué hacés!! cómo te va?",
    "eyyy apareció!! qué tal todo?",
    "Holaaaa cómo estás??",
    "Hey!! todo bien por ahí?",
    "Holaaaaaaa!! qué hacés?",
    "eyyy 💜 qué onda?",
    "Holaaaa apareciste!! qué hay?",
    "Hey qué onda!! cómo te va?",
    "Holaaaa!! cuánto sin verte jajaja",
    "eyyy cómo andás??",
    "Holaaaa todo bien?? 💜",
    "Hey!! qué hay de nuevo?",
    "eyyy apareció al fin jajaja",
    "Holaaaa!! qué tal?",
    "Hola!! cómo estás?? 💜",
    "eyyy qué onda todo?"
  ],
  comoEstas_extra: [
    ...
    "Bastante bien gracias!! acá pensando en cosas raras\nVos?",
    "Re bien acá con las cobayas que son adorables\nVos?",
